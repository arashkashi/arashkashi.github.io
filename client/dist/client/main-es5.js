...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcAppAddNewProductAddNewProductComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function AddNewProductComponent_p_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AddNewProductComponent_button_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AddNewProductComponent_button_14_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 8);
    ...
    var AddNewProductComponent = /*#__PURE__*/function () {
      function AddNewProductComponent(formBuilder, apiService, router, route) {
      ...
      _createClass(AddNewProductComponent, [{
        ...
        key: "isFormStatusValid",
        value: function isFormStatusValid() {
          return this.form.status == 'INVALID';
        }
      }, {
        key: "onFetchingProductSuccess",
        value: function onFetchingProductSuccess(product) {
        ...
        value: function ngOnInit() {
          ...
          this.route.paramMap.subscribe(function (params) {
            _this.product_id = params.get('productId');

            _this.apiService.dispatchPostRequest("/api/products/" + _this.product_id, {}).then(function (res) {
              _this.onFetchingProductSuccess(res['product']);
            }, function (msg) {});
          });
        }
      }, {
        key: "onSubmit",
        value: function onSubmit(productData) {
          var _this2 = this;
          ...
          if (this.product_id) {
            ...
            this.apiService.dispatchPostRequest("/api/products/update", {
              'product': productData
            }).then(function (res) {
              _this2.router.navigate(['products']);
            }, function (msg) {
              _this2.error = JSON.stringify(msg);
            });
            return;
          } else {
            this.apiService.dispatchPostRequest("/api/products/addNewProduct", productData).then(function (res) {
              if (!res['error']) {
                _this2.router.navigate(['products']);
              } else {
                _this2.error = JSON.stringify(res);
              }
            }, function (msg) {
              _this2.error = JSON.stringify(msg);
            });
    ...
    AddNewProductComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 15,
      vars: 6,
      consts: [[1, "col-container"], [1, "col-container", 3, "formGroup", "ngSubmit"], ["for", "name"], ["id", "name", "type", "text", "formControlName", "name", 3, "ngModel", "ngModelChange"], ["for", "properties"], ["id", "properties", "type", "text", "formControlName", "properties", 3, "ngModel", "ngModelChange"], [4, "ngIf"], ["class", "button", "type", "submit", 4, "ngIf"], ["type", "submit", 1, "button"]],
      template: function AddNewProductComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AddNewProductComponent_Template_form_ngSubmit_3_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddNewProductComponent_Template_input_ngModelChange_7_listener($event) {
            return ctx.enteredName = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddNewProductComponent_Template_input_ngModelChange_11_listener($event) {
            return ctx.enteredProperties = $event;
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AddNewProductComponent, [{
        ...
        return [{
          ...
          type: _api_request_service__WEBPACK_IMPORTED_MODULE_3__["ApiRequestService"]
        }, {
  ...
  function srcAppApiRequestServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "ApiRequestService", function () {
    ...
    var ApiRequestService = /*#__PURE__*/function () {
      function ApiRequestService(http, localStorageService) {
        _classCallCheck(this, ApiRequestService);

        this.http = http;
        this.localStorageService = localStorageService;
      }

      _createClass(ApiRequestService, [{
        key: "dispatchPostRequest",
        value: function dispatchPostRequest(path, data) {
          var requiresAuth = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;

          if (requiresAuth) {
            var token = this.localStorageService.locallyStoredToken();
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
              "bearer": token
            });
            return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api_endpoint + path, data, {
              headers: headers
            }).toPromise();
          } else {
        ...
        key: "dispatchPostFormDataRequest",
        value: function dispatchPostFormDataRequest(path, formData) {
          var token = this.localStorageService.locallyStoredToken();
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
            "bearer": token
          });
          ...
          return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api_endpoint + path, formData, {
            headers: headers
          }).toPromise();
        }
      }]);
    ...
    ApiRequestService.ɵfac = function ApiRequestService_Factory(t) {
      return new (t || ApiRequestService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_local_storage_service__WEBPACK_IMPORTED_MODULE_3__["LocalStorageService"]));
    };

    ApiRequestService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ApiRequestService, [{
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _register_new_user_register_new_user_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./register-new-user/register-new-user.component */
    ...
    var _main_menu_main_menu_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _add_new_product_add_new_product_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var routes = [{
      path: 'register',
      component: _register_new_user_register_new_user_component__WEBPACK_IMPORTED_MODULE_2__["RegisterNewUserComponent"]
    }, {
      path: 'login',
      ...
      component: _add_new_product_add_new_product_component__WEBPACK_IMPORTED_MODULE_7__["AddNewProductComponent"]
    }, {
      path: 'products/edit/:productId',
      component: _add_new_product_add_new_product_component__WEBPACK_IMPORTED_MODULE_7__["AddNewProductComponent"]
    }, {
      path: 'files/add',
      component: _files_files_component__WEBPACK_IMPORTED_MODULE_8__["FilesComponent"]
    }];
  ...
  /***/
  function srcAppAppTopBarAppTopBarComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function AppTopBarComponent_a_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var AppTopBarComponent = /*#__PURE__*/function () {
      function AppTopBarComponent(storage) {
    ...
    AppTopBarComponent.ɵfac = function AppTopBarComponent_Factory(t) {
      return new (t || AppTopBarComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_local_storage_service__WEBPACK_IMPORTED_MODULE_2__["LocalStorageService"]));
    };
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_top_bar_app_top_bar_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./app-top-bar/app-top-bar.component */
    "./src/app/app-top-bar/app-top-bar.component.ts");
    /* harmony import */
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_app_top_bar_app_top_bar_component__WEBPACK_IMPORTED_MODULE_1__["AppTopBarComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_top_bar_app_top_bar_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./app-top-bar/app-top-bar.component */
    "./src/app/app-top-bar/app-top-bar.component.ts");
    /* harmony import */


    var _register_new_user_register_new_user_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./register-new-user/register-new-user.component */
    "./src/app/register-new-user/register-new-user.component.ts");
    /* harmony import */
    ...
    var _add_new_product_add_new_product_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./add-new-product/add-new-product.component */
    "./src/app/add-new-product/add-new-product.component.ts");
    /* harmony import */
    ...
    var _files_files_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./files/files.component */
    "./src/app/files/files.component.ts");
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_14__["MatIconModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_15__["MatCardModule"], _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_16__["MatProgressBarModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _app_top_bar_app_top_bar_component__WEBPACK_IMPORTED_MODULE_5__["AppTopBarComponent"], _register_new_user_register_new_user_component__WEBPACK_IMPORTED_MODULE_6__["RegisterNewUserComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"], _user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_10__["UserProfileComponent"], _main_menu_main_menu_component__WEBPACK_IMPORTED_MODULE_11__["MainMenuComponent"], _products_products_component__WEBPACK_IMPORTED_MODULE_12__["ProductsComponent"], _add_new_product_add_new_product_component__WEBPACK_IMPORTED_MODULE_13__["AddNewProductComponent"], _files_files_component__WEBPACK_IMPORTED_MODULE_17__["FilesComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_14__["MatIconModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_15__["MatCardModule"], _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_16__["MatProgressBarModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppFilesFilesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function FilesComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function FilesComponent_div_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function FilesComponent_div_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function FilesComponent_button_11_Template(rf, ctx) {
      if (rf & 1) {
        var _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 12);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FilesComponent_button_11_Template_button_click_0_listener() {
    ...
    var FilesComponent = /*#__PURE__*/function () {
      function FilesComponent(http, localStorageService, loginServie, route) {
      ...
      _createClass(FilesComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.paramMap.subscribe(function (params) {
            _this3.foreign_key = params.get('foreignKey');
            _this3.isPublic = params.get('isPublic');
          });
        }
      }, {
        key: "preview",
        value: function preview() {
          ...
          reader.onload = function (_event) {
            _this4.previewUrl = reader.result;
          };
        }
      }, {
        key: "onSubmit",
        value: function onSubmit() {
          ...
          this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api_endpoint + '/api/files/save', formData, {
            headers: headers
          }).subscribe(function (res) {
            alert("File uploaded successfully! Now you can go back or upload more files for this item.");
            _this5.fileData = null;
            _this5.previewUrl = null;
            _this5.uploadedFilePath = null;
          }, function (msg) {
            alert(JSON.stringify(msg['error']['message']));

            if (_this5.fileData) {
              _this5.showSubmitButton = true;
            }
          });
        }
      }]);
    ...
    FilesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 12,
      vars: 4,
      consts: [[1, "container"], [1, "row"], [1, "col-md-6", "offset-md-3"], [1, "form-group"], ["type", "file", "name", "image", 3, "change"], [4, "ngIf"], ["class", "image-preview mb-3", 4, "ngIf"], ["class", "mb-3", 4, "ngIf"], ["class", "btn btn-primary", 3, "click", 4, "ngIf"], [1, "image-preview", "mb-3"], ["height", "300", 3, "src"], [1, "mb-3"], [1, "btn", "btn-primary", 3, "click"]],
      template: function FilesComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function FilesComponent_Template_input_change_6_listener($event) {
  ...
  function srcAppLocalStorageServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _node_modules_crypto_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../node_modules/crypto-js */
    "./node_modules/crypto-js/index.js");
    /* harmony import */


    var _node_modules_crypto_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_crypto_js__WEBPACK_IMPORTED_MODULE_1__);
    ...
    var LocalStorageService = /*#__PURE__*/function () {
      ...
      _createClass(LocalStorageService, [{
        key: "setTokenLocally",
        value: function setTokenLocally(token) {
          var encrypted = this.encryptData({
            kWeather: token
          });
          localStorage.setItem(this.kToken, encrypted);
        }
      }, {
        key: "locallyStoredToken",
        value: function locallyStoredToken() {
          var encrypted = localStorage.getItem(this.kToken);
        ...
        key: "setLoggedInUserId",
        value: function setLoggedInUserId(userId) {
          localStorage.setItem(this.kUserId, userId);
        }
      }, {
        key: "loggedInUserId",
        value: function loggedInUserId() {
        ...
        value: function decryptData(data) {
          try {
            var bytes = _node_modules_crypto_js__WEBPACK_IMPORTED_MODULE_1__["AES"].decrypt(data, this.encryptSecretKey);
  ...
  function srcAppLoginServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginService = /*#__PURE__*/function () {
      function LoginService(apiService, cookie, router) {
      ...
      _createClass(LoginService, [{
        key: "loginObservable",
        value: function loginObservable(user) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginService, [{
        ...
        return [{
          type: _api_request_service__WEBPACK_IMPORTED_MODULE_1__["ApiRequestService"]
        }, {
          type: _local_storage_service__WEBPACK_IMPORTED_MODULE_2__["LocalStorageService"]
        }, {
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(loginService, router, formBuilder, localStorageService) {
      ...
      _createClass(LoginComponent, [{
        ...
        key: "onSuccessfulLogin",
        value: function onSuccessfulLogin(login_response) {
        ...
        value: function onSubmit(customerData) {
          ...
          this.loginService.loginObservable(customerData).then(function (res) {
            _this6.onSuccessfulLogin(res);
          }, function (msg) {
            _this6.error = JSON.stringify(msg);
          });
        }
      }, {
        key: "onRegisterClick",
    ...
    LoginComponent.ɵfac = function LoginComponent_Factory(t) {
      return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_login_service__WEBPACK_IMPORTED_MODULE_3__["LoginService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_local_storage_service__WEBPACK_IMPORTED_MODULE_5__["LocalStorageService"]));
    };
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 25,
      vars: 3,
      consts: [[1, "col-container", 3, "formGroup", "ngSubmit"], ["for", "email"], ["id", "email", "type", "username", "autocomplete", "username", "formControlName", "email"], ["for", "password"], ["id", "password", "type", "password", "autocomplete", "new-password", "formControlName", "password"], [4, "ngIf"], ["class", "button", "type", "submit", 4, "ngIf"], ["tabindex", "0", 1, "card", "card-small", 3, "click"], ["type", "submit", 1, "button"]],
      template: function LoginComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_div_click_22_listener() {
  ...
  function srcAppMainMenuMainMenuComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MainMenuComponent = /*#__PURE__*/function () {
      function MainMenuComponent(router, loginService) {
      ...
      _createClass(MainMenuComponent, [{
        ...
        key: "onProductsClick",
        value: function onProductsClick() {
    ...
    MainMenuComponent.ɵfac = function MainMenuComponent_Factory(t) {
      return new (t || MainMenuComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_login_service__WEBPACK_IMPORTED_MODULE_2__["LoginService"]));
    };
    ...
    MainMenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 7,
      vars: 0,
      consts: [[1, "card-container"], ["tabindex", "0", 1, "card", "card-small", 3, "click"]],
      template: function MainMenuComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MainMenuComponent_Template_div_click_1_listener() {
            return ctx.onProductsClick();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MainMenuComponent_Template_div_click_4_listener() {
  ...
  function srcAppProductsProductsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ProductsComponent_p_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function ProductsComponent_span_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ProductsComponent_span_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function ProductsComponent_tr_14_td_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductsComponent_tr_14_td_1_Template_mat_icon_click_1_listener() {
          ...
          return ctx_r9.onDeleteProductClick(p_r4);
        });
    ...
    function ProductsComponent_tr_14_td_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductsComponent_tr_14_td_2_Template_mat_icon_click_1_listener() {
          ...
          return ctx_r12.onEditProductClick(p_r4);
        });
    ...
    function ProductsComponent_tr_14_td_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductsComponent_tr_14_td_3_Template_mat_icon_click_1_listener() {
          ...
          return ctx_r15.onAddProductImageClick(p_r4);
        });
    ...
    function ProductsComponent_tr_14_td_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td");
    ...
    var ProductsComponent = /*#__PURE__*/function () {
      function ProductsComponent(router, api) {
      ...
      _createClass(ProductsComponent, [{
        ...
        key: "onAllProducts",
        value: function onAllProducts(products) {
          this.products = products;
        }
      }, {
        key: "listSortedPropertyKeyValues",
        value: function listSortedPropertyKeyValues(product) {
          var json = JSON.parse(product['properties']);
          var keys = Object.keys(json).sort(function (one, two) {
            return one > two ? 1 : -1;
          });
          var result = [];
        ...
        value: function onRefreshClick() {
          ...
          this.api.dispatchPostRequest("/api/products", {}).then(function (res) {
            _this7.onAllProducts(res['products']);
          }, function (msg) {
            _this7.error = JSON.stringify(msg);
          });
        }
      }, {
        key: "onEditModeClick",
        value: function onEditModeClick() {
          this.isEditModeEnabled = !this.isEditModeEnabled;
        }
      }, {
        key: "onEditProductClick",
        value: function onEditProductClick(p) {
          var id = p['id'];
          this.router.navigate(['products/edit/' + id]);
        }
      }, {
        key: "onDeleteProductClick",
        value: function onDeleteProductClick(product) {
          var _this8 = this;

          var id = product['id'];

          if (confirm("Should delete " + product['name'] + " ?")) {
            this.api.dispatchPostRequest("/api/products/delete/" + id, {}).then(function (res) {
              _this8.onRefreshClick();
            }, function (msg) {
              _this8.error = JSON.stringify(msg);
            });
          }
        }
      }, {
        key: "onAddProductImageClick",
        value: function onAddProductImageClick(product) {
          var foreigh_key = product.id;
          this.router.navigate(['files/add/', {
            foreignKey: product.id,
            isPublic: "true"
          }]);
        }
      }, {
        key: "onAddNewProductClick",
        value: function onAddNewProductClick() {
    ...
    ProductsComponent.ɵfac = function ProductsComponent_Factory(t) {
      return new (t || ProductsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_api_request_service__WEBPACK_IMPORTED_MODULE_2__["ApiRequestService"]));
    };
    ...
    ProductsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 15,
      vars: 4,
      consts: [[1, "card-container"], [4, "ngIf"], ["tabindex", "0", 1, "card", "card-small", 3, "click"], [1, "table-responsive"], [1, "table", "table-striped", "w-auto"], [4, "ngFor", "ngForOf"], [1, "warning", 3, "click"], [3, "click"]],
      template: function ProductsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductsComponent_Template_div_click_2_listener() {
            return ctx.onAddNewProductClick();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductsComponent_Template_div_click_5_listener() {
            return ctx.onRefreshClick();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductsComponent_Template_div_click_8_listener() {
            return ctx.onEditModeClick();
          });
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_4__["MatIcon"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductsComponent, [{
        ...
        return [{
          ...
          type: _api_request_service__WEBPACK_IMPORTED_MODULE_2__["ApiRequestService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppRegisterNewUserRegisterNewUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RegisterNewUserComponent", function () {
    ...
    function RegisterNewUserComponent_p_20_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function RegisterNewUserComponent_button_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 12);
    ...
    var RegisterNewUserComponent = /*#__PURE__*/function () {
      function RegisterNewUserComponent(formBuilder, apiService, router) {
        _classCallCheck(this, RegisterNewUserComponent);
      ...
      _createClass(RegisterNewUserComponent, [{
        key: "isFormStatusValid",
        value: function isFormStatusValid() {
        ...
        value: function onSubmit(customerData) {
          ...
          this.apiService.dispatchPostRequest("/register", customerData, false).then(function (res) {
            _this9.router.navigate(['login']);
          }, function (msg) {
            _this9.error = JSON.stringify(msg);
          });
        }
      }]);
    ...
    RegisterNewUserComponent.ɵfac = function RegisterNewUserComponent_Factory(t) {
      return new (t || RegisterNewUserComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_api_request_service__WEBPACK_IMPORTED_MODULE_2__["ApiRequestService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
    };

    RegisterNewUserComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: RegisterNewUserComponent,
      selectors: [["app-register-new-user"]],
      decls: 22,
      vars: 3,
      consts: [[1, "col-container"], [1, "col-container", 3, "formGroup", "ngSubmit"], ["for", "name"], ["id", "name", "type", "text", "formControlName", "name"], ["for", "email"], ["id", "email", "type", "username", "autocomplete", "username", "formControlName", "email"], ["for", "password"], ["id", "password", "type", "password", "autocomplete", "new-password", "formControlName", "password"], ["for", "confirm_password"], ["id", "confirm_password", "type", "password", "autocomplete", "new-password", "formControlName", "password_confirmation"], [4, "ngIf"], ["class", "button", "type", "submit", 4, "ngIf"], ["type", "submit", 1, "button"]],
      template: function RegisterNewUserComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h1", 0);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function RegisterNewUserComponent_Template_form_ngSubmit_3_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RegisterNewUserComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppUserProfileUserProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function UserProfileComponent_p_11_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    var UserProfileComponent = /*#__PURE__*/function () {
      function UserProfileComponent(route, apiService) {
      ...
      _createClass(UserProfileComponent, [{
        key: "onFetchingUserSuccess",
        value: function onFetchingUserSuccess(user) {
          this.name = user['name'];
        ...
        value: function ngOnInit() {
          ...
          this.route.paramMap.subscribe(function (params) {
            _this10.user_id = params.get('userId');

            _this10.apiService.dispatchPostRequest("/api/users/" + _this10.user_id, {}).then(function (res) {
              _this10.onFetchingUserSuccess(res['user']);
            }, function (msg) {
              _this10.error = JSON.stringify(msg);
    ...
    UserProfileComponent.ɵfac = function UserProfileComponent_Factory(t) {
      return new (t || UserProfileComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_api_request_service__WEBPACK_IMPORTED_MODULE_2__["ApiRequestService"]));
    };
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/arash/Desktop/nesha/client/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
